...
public class MySalesListViewHandler {
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenPostHided_then_UPDATE_1(@Payload PostHided postHided) {
        try {
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenDealReserved_then_UPDATE_3(
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenDealCanceled_then_UPDATE_4(
